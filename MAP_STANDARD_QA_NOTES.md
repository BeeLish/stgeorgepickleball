...
| Street-map fallback | Dixie Springs Park; Entrada; Sullivan Virgin River Park; SunRiver Pickleball Complex; Vernon Worthen Park; Vintage Home Owners Association |
...
The production build generated 22 venue pages: **16 satellite embeds and 6 documented street-map fallbacks**. All 22 iframe endpoints returned HTTP 200. All 22 separate **Open in Google Maps** URLs returned HTTP 200. Every pre-rendered venue page contains its map treatment, tight zoom, and outbound Google Maps link before JavaScript runs.
